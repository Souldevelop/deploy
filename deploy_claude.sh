...
apply_apt_sources_list() {
...

    {
        ...
        echo "## Mirror: ${mirror}"
        echo "deb ${proto}://${mirror}/${APT_REPO_PATH} ${CODENAME} ${components}"
        echo "deb ${proto}://${mirror}/${APT_REPO_PATH} ${CODENAME}-updates ${components}"
        echo "deb ${proto}://${mirror}/${APT_REPO_PATH} ${CODENAME}-backports ${components}"
        echo "deb ${proto}://${mirror}/${APT_REPO_PATH} ${sec_suite} ${components}"
...
## Mirror: ${mirror}
Types: deb
URIs: ${proto}://${mirror}/${APT_REPO_PATH}
